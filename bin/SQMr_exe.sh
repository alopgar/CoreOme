...
export paramfile=$WDIR/Rparams.R
export phenotmod=$WDIR/Rphenotmods.R

## MODULE LOADING AND SCRIPT RUNNING
module load cesga/2018 gcc/6.4.0 R/4.0.2 parallel jdk/8u181
cd $WDIR
...
Rscript $BINPATH/Filter11_Samples.R $paramfile" > $job11
...
Rscript $BINPATH/Filter21_Subsets.R $paramfile $phenotmod" > $job21
