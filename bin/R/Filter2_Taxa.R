...
nope <- c("Acanthocephala", "Annelida", "Arthropoda", "Brachiopoda", "Bryozoa", "Chaetognatha", "Chlorophyta", "Chordata", "Cnidaria", "Ctenophora", 
          "Echinodermata", "Entoprocta", "Gnathostomulida", "Hemichordata", "Mollusca", "Nematoda", "Nematomorpha", "Nemertea", "Onychophora", 
          "Placozoa", "Platyhelminthes", "Porifera", "Rhodophyta", "Rotifera", "Streptophyta", "Tardigrada", "Xenacoelomorpha")
...
sgt_mdata <- aggregate(. ~ superkingdom + phylum + class + order + family + genus, sgt_mdata, sum)
sgt_mdata$genus <- with(sgt_mdata, ave(genus, FUN = make.unique))
